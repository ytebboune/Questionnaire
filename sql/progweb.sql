...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 16 oct. 2017 à 17:45
...
(12, 6, 0, 'Question PHP 3 ?', 'indice PHP 3', 3),
(13, 8, 12, 'QuestJava01', 'Question Java', 3);
...
(9, 13, 'MauvaiseRepJava'),
(10, 13, 'MauvRep'),
(11, 13, 'RepNulle'),
(12, 13, 'BonneREPONSEJava');
...
INSERT INTO `score` (`id_question`, `id_utilisateur`, `score`) VALUES
(13, 2, 0),
(13, 2, 3);
...
--
ALTER TABLE `question`
  MODIFY `id_question` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT pour la table `reponse`
--
ALTER TABLE `reponse`
  MODIFY `id_reponse` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
